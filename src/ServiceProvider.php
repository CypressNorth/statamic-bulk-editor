...
namespace CypressNorth\StatamicBulkEditor;

use CypressNorth\StatamicBulkEditor\Http\Controllers\BulkEditorConfigController;
...
class ServiceProvider extends AddonServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ . "/../resources/views/", 'cn-bulk-editor');

        Utility::extend(function () {
            Utility::register('cn-bulk-editor')
                ->title(__('Bulk Editor'))
                ->description(__('statamic-bulk-editor::messages.utility_description'))
